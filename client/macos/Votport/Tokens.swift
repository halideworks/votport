...
// The votport tokens, from client/design/tokens.json (generated by
// scripts/design-tokens.mjs from web/assets/style.css), dark block.
// ponytail: the values are copied by hand from that file; a build step that
// reads it is the upgrade when the token set grows.
enum Tokens {
    ...
    static let panelHover = Color.white.opacity(0.045)
