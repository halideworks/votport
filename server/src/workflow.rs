...
/// Audit 438: every permission refusal names who to ask and for what, in
/// one shape, matching the projects page guidance. Shared by the API and
/// the store, whose error types differ.
pub fn permission_refusal(access: &str) -> String {
    format!("Ask an administrator for {access} access to this project.")
}
